...
Global $LO_PDF, $LO_Presentation, $LO_XML;
	...
	//Graphique du financement :
	$LC_Image = "../Ajax/FINANCEMENT_" . TOOL_SessionLire("SESSION", "SCI_ALIAS") . ".jpg";
...
Global $LO_PDF, $LO_Presentation, $LO_XML;
	...
	PDF_Style("SOUSTITRE");
	$LO_PDF->Text(105, $LN_Ligne, PDF_CentreLibelle("Les recettes",210/2));
...
Global $LO_PDF, $LO_Presentation, $LO_XML;
	...
	PDF_Style("SOUSTITRE");
	$LO_PDF->Text(1, $LN_Ligne, PDF_CentreLibelle("Les charges",210/2));
	$LN_Ligne += $LO_Presentation->LN_HautLigNormale*2;
	PDF_Style("DETAIL");	
...
Function PDF_TresoFinCredit() {
	...
	//echo "****" . $LN_DureeCredit;
	$LC_TypeFiscalite = $LO_XML->investisseur->fiscalite->typefiscalite;
	//echo count($LT_Elements) . " / " . $LN_DureeCredit . "  /  " . $LO_XML->simulation->duree*12 ;
	if ($LC_TypeFiscalite=="indiv") {
